...
//its like this
//localhost:8800/users?userId=621e6622
//localhost:8800/users?username=john
// i.e., we can use both of them by using query
  ...
  if (req.body.userId !== req.params.id) {
    try {
      ...
      if (!user.followers.includes(req.body.userId)) {
        //in the parameter id represents the user that we are going to follow.
        //in the body the id represents the current user who is logged in.
